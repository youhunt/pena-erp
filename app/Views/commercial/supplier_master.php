...
<?= $this->section('title') ?>Supplier Master<?= $this->endSection() ?>

<?= $this->section('content') ?>
<div class="page-title-box d-flex align-items-center justify-content-between">
    <div>
        <h4 class="mb-sm-0 font-size-18">Supplier Master</h4>
        <p class="text-muted mb-0"><?= esc($tenantContext['company_name']) ?> / Detailed supplier master</p>
    </div>
</div>
...
<div class="row">
    <div class="col-xl-5">
        <div class="card">
            <div class="card-body">
                ...
                <?php else : ?>
                <form method="post" action="<?= site_url('purchasing/suppliers') ?>">
                    <?= csrf_field() ?>
                    <div class="row g-2">
                        ...
                        <div class="col-md-4"><label class="form-label">Supplier Code</label><input name="code" class="form-control" maxlength="12" required></div>
                        <div class="col-md-6"><label class="form-label">Supplier Name</label><input name="name" class="form-control" maxlength="500" required></div>
                        <div class="col-md-6"><label class="form-label">Supplier Ref Name</label><input name="ref_name" class="form-control" maxlength="500"></div>
                        <div class="col-md-6"><label class="form-label">Contact Name</label><input name="contact_name" class="form-control" maxlength="100"></div>
                        ...
                        <div class="col-md-6"><label class="form-label">Limit Amount</label><input name="limit_amount" type="number" step="0.000001" class="form-control"></div>
                        ...
                        <div class="col-md-6"><label class="form-label">Employee Code</label><input name="employee_code" class="form-control" maxlength="15"></div>
                        <div class="col-md-6"><label class="form-label">Purchasing Name</label><input name="purchasing_name" class="form-control" maxlength="100"></div>
                    </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6"><input name="office_contact_name" class="form-control" placeholder="Contact Name"></div><div class="col-md-6"><input name="office_phone_number" class="form-control" placeholder="Phone"></div>
                        <div class="col-md-6"><input name="office_handphone" class="form-control" placeholder="Handphone"></div>
                    </div>

                    <hr>
                    <h5>Mail / Billing / Ship To</h5>
                    <div class="row g-2">
                        <div class="col-12"><textarea name="mail_address" class="form-control" placeholder="Mail Address"></textarea></div>
                        <div class="col-md-6"><input name="mail_city" class="form-control" placeholder="Mail City"></div><div class="col-md-6"><input name="mail_contact_name" class="form-control" placeholder="Mail Contact"></div>
                        ...
                        <div class="col-md-6"><input name="ship_to_city" class="form-control" placeholder="Ship To City"></div><div class="col-md-6"><input name="ship_to_contact_name" class="form-control" placeholder="Ship To Contact"></div>
                    </div>
                    ...
                    <div class="mt-3"><button class="btn btn-primary">Simpan Supplier</button></div>
                </form>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-xl-7">
        <div class="card"><div class="card-body"><h4 class="card-title">Supplier List</h4><div class="table-responsive"><table class="table table-sm table-bordered align-middle"><thead class="table-light"><tr><th>Code</th><th>Name</th><th>Currency</th><th>Terms</th><th>Status</th></tr></thead><tbody><?php foreach ($suppliers as $supplier) : ?><tr><td><?= esc($supplier['code']) ?></td><td><?= esc($supplier['name']) ?></td><td><?= esc($supplier['currency_code']) ?></td><td><?= esc($supplier['term_code'] ?? '-') ?></td><td><?= esc($supplier['status']) ?></td></tr><?php endforeach; ?><?php if ($suppliers === []) : ?><tr><td colspan="5" class="text-muted text-center">Belum ada supplier.</td></tr><?php endif; ?></tbody></table></div></div></div>
    </div>
</div>
<?= $this->endSection() ?>
