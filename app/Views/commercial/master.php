...
<div class="page-title-box d-flex align-items-center justify-content-between">
    <div>
        ...
        <p class="text-muted mb-0"><?= esc($tenantContext['company_name']) ?> / <?= esc($partnerLabel) ?>, Terms, Promo dan Address</p>
    </div>
    ...
    <div class="col-xl-5">
        <div class="card"><div class="card-body">
            ...
            <form method="post" action="<?= site_url($side . '/master/addresses') ?>" class="row g-2 align-items-end">
                ...
                <div class="col-md-3"><label class="form-label">Type</label><select name="address_type" class="form-select"><option value="billing">Billing</option><option value="shipping">Shipping</option><option value="office">Office</option><option value="pickup">Pickup</option></select></div>
